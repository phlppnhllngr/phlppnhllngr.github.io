...
## wichtigste Änderungen & Sprachfeatures
- var (10)
- JAXB (javax.xml.bind) nicht mehr in JDK (11)
- JAX-WS (javax.xml.ws) nicht mehr in JDK (11)
- java.net.http.HttpClient (11)
- Launch single-file source-code programs (11)
- Switch enhancements, yield (13)
- Records (14)
- Helpful NullPointerExceptions (14: `-XX:+ShowCodeDetailsInExceptionMessages`)
- Text blocks (15)
- Simple web server (18)
- Structured concurrency (19-23: preview)
- Autogenerated shared archive (19)
- implicite class + instance main method (21-23: preview)
- Virtual threads (21)
- String templates (21+22: preview, 23: wieder entfernt)
...
- **Andere OpenJDK Distributionen**
    ...
    - viele Hersteller stimmen darin überein, dass Java 11, 17, ... LTS-Versionen sein sollen
        - *Amazon Corretto and Eclipse Temurin both treat JDK 8/11/17/21 as special LTS releases with longer support windows than the others.*
        - *The entire community of Java libraries and frameworks like all the Apache projects, they all treat 8/11/17/21 as the real Java releases and the others as temporary Java releases.*
